    ...
    <div className="flex h-[calc(100vh-4rem)] bg-slate-50 dark:bg-slate-950 overflow-hidden transition-colors duration-200">
      ...
      <aside className="w-72 hidden md:flex flex-col glass-panel border-r border-slate-200/80 dark:border-slate-800/80 p-4 transition-colors">
        <button
          ...
          className="flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white font-bold text-xs shadow-lg shadow-emerald-600/20 btn-interactive btn-primary-glow"
        >
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative min-w-0 max-w-full">
        ...
        <div className="glass-panel border-b border-slate-200/80 dark:border-slate-800/80 px-2.5 sm:px-4 py-2 flex items-center justify-between gap-2 overflow-x-auto transition-colors min-w-0 max-w-full">
          <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto min-w-0 flex-1">
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`px-2.5 sm:px-3 py-1 rounded-full text-[11px] sm:text-xs font-medium whitespace-nowrap transition-all duration-150 btn-interactive flex-shrink-0 ${
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            <div className="flex items-center gap-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-1.5 sm:px-2 py-1 shadow-sm transition-colors">
            ...
            <div className="relative">
              <button
                ...
                className="p-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:text-emerald-500 shadow-sm btn-interactive"
              ...
              {showExportMenu && (
                <div
                  ...
                  className="absolute right-0 mt-2 w-44 glass-panel rounded-2xl shadow-2xl py-1.5 border border-slate-200 dark:border-slate-700 z-50 animate-scale-in"
                >
                  <button
                    onClick={() => handleExportChat('md')}
                    className="w-full flex items-center gap-2 px-3.5 py-2 text-xs text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3.5 py-2 text-xs text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  >
        ...
        <div className="flex-1 overflow-y-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-4 min-w-0 max-w-full">
          {messages.length === 0 && !isStreaming ? (
            ...
            <div className="max-w-3xl mx-auto py-6 sm:py-12 text-center animate-fade-in min-w-0">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center text-white mx-auto shadow-xl shadow-emerald-500/20 mb-3 sm:mb-4 animate-float-subtle">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 max-w-2xl mx-auto text-left min-w-0">
                {INITIAL_SUGGESTED_QUESTIONS.map((item, idx) => (
                  <div
                    ...
                    className="glass-card glass-card-hover card-lift p-3 sm:p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800 cursor-pointer flex items-center justify-between group shadow-sm min-w-0 btn-interactive"
                  >
                    ...
                    <ChevronRight className="w-4 h-4 text-slate-400 dark:text-slate-600 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 group-hover:translate-x-1 transition-all flex-shrink-0" />
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="p-3 sm:p-5 glass-panel border-t border-slate-200/80 dark:border-slate-800/80 transition-colors min-w-0 max-w-full">
          ...
          >
            ...
            <button
              ...
              className="p-3 sm:p-3.5 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 disabled:opacity-40 disabled:hover:from-emerald-600 text-white font-semibold shadow-lg shadow-emerald-500/20 btn-interactive btn-primary-glow flex-shrink-0 flex items-center justify-center"
            >
              {isStreaming ? (
